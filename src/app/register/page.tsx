            ...
            <div className="">
                <form className="border bg-white w-[300px] p-6 rounded-xl">
                    <div>
                        ...
                        <div>
                            <input className="border w-full h-8 text-sm px-2" type="type" />
                        </div>
                    </div>
                    <div className="mt-3">
                    ...
                    <p className="text-sm mt-4 text-center">Already have an account? <Link href="/" className="text-red-700/80">Login</Link></p>
                </form>
            </div>
        </main>
    );
